...
--Mostrar todas las visitas que no fueron realizadas por el jesuita con id 5
	SELECT *
		FROM visita
			WHERE idJesuita != 5;
--Los jesuitas con id menor de 10
	SELECT *
		FROM jesuita
			WHERE idJesuita < 10;
--Visitas realizadas entre el 20 de marzo y el 31 de marzo 
	SELECT *
		FROM visita
			WHERE FechaHora BETWEEN '2024-03-20' AND '2024-03-31';
...
--  Jesuitas que no comienzan con San
	SELECT *
		FROM jesuita
